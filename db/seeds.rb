...
user.assistants.create! name: "Perplexity Sonar", model: "llama-3.1-sonar-large-128k-online7", api_protocol: "OPEN_AI", api_url: "https://api.perplexity.ai/", supports_images: true
